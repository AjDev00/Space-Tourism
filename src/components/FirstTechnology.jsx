...
export default function FirstTechnology() {
  const { changeTechToSpace, changeTechToCapsule } = useContext(AppContext);
  return (
    <div>
      <div className="static pt-20 text-white">
        ...
        <div className="md:flex flex-row-reverse md:px-44 md:gap-24 md:pb-10">
          <div className="pt-10 md:hidden">
            <img src={vehicle} alt="" className="h-56" />
          </div>
          <div className="hidden md:flex">
            <img src={vehicle1} alt="" className="w-[600px] h-[470px]" />
          </div>
          <div className="md:flex flex-row md:gap-14">
            ...
            <div className="flex flex-col justify-center items-center pt-4 pb-12 md:justify-normal md:items-start md:mt-28 md:opacity-70">
              ...
              <h4 className="font-serif text-3xl">LAUNCH VEHICLE</h4>
              <div className="ml-3 md:ml-0">
                <p className="font-barlow px-5 mt-5 md:px-0">
                  ...
                  Standing 150 metres tall, it's quite an awe-inspiring sight on
                  the launch pad!
                </p>
              </div>
            </div>
